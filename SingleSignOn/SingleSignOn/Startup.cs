using SingleSignOn.Infrastructure.Configs;
using SingleSignOn.Infrastructure.Extensions;
...
namespace SingleSignOn
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "SingleSignOn ASP.NET Core API v1");
            });
